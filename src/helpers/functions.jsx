...
export const unixTimestampToTime = (unixTimestamp) => {
...
export const getUTCDatetime = () => {
    ...
    const utcTime = date.toLocaleString('en-US', {
        hour: '2-digit',
        minute: '2-digit',
        hourCycle: 'h12', // Use 12-hour cycle
